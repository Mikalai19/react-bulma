...
const text = {
    word: 'This is a React ',
    description: 'React uses lot of tech companies such us Facebook, Instagram and many many more'
}
                                    ...
                                    <div className="tile is-parent">
                                        <article className="tile is-child notification is-white">
                                            ...
                                            <figure className="image is-4by3">
                                                <img src="https://picsum.photos/640/480/?random" alt="Description" title="pic" />
                                            </figure>
                                        </article>
                                    </div>
                                </div>
